...
function renderCities(){
    ...
    for (i=0; i<cityList.length; i++){
        var a = $("<a>");
        a.addClass("list-group-item list-group-item-action list-group-item-primary city bg-dark text-white");
...
async function displayWeather() {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + cityname + "&units=imperial&appid=7dfb88bc828271e0d4dcd0c5ea288918";
    ...
    var response = await $.ajax({
        ...
        var uvURL = "https://api.openweathermap.org/data/2.5/uvi?appid=7dfb88bc828271e0d4dcd0c5ea288918&lat="+getLat+"&lon="+getLong;
...
async function displayFiveDayForecast() {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/forecast?q="+cityname+"&units=imperial&appid=7dfb88bc828271e0d4dcd0c5ea288918";
    ...
    var response = await $.ajax({
      ...
      var cardDeck = $("<div  class='card-deck bg-dark'>");
      forecastDiv.append(cardDeck);
      
      console.log(response);
      for (i=0; i<5;i++){
          var forecastCard = $("<div class='card mb-3 mt-3'>");
          var cardBody = $("<div class='card-body bg-light'>");
          var date = new Date();
